...
public slots:
	...
	void set_recording_location(const QString &location)
	{
		m_recording_location =
		    location.simplified().toLower() ==
		        QStringLiteral("app")
		    ? QStringLiteral("app")
	...
	QString get_recording_location()
	{
...
private:
	...
	QString m_recording_location = QStringLiteral("shared");
